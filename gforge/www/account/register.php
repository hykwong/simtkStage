...
<div class="module_account_setup">
	<h2>Account setup</h2>
	<p><span class="required_note">Required fields outlined in blue.</span> After registering, validate your account though email.</p>
	<div class="account_table">
		<div class="account_row">
			<div class="account_column">
				<input type="text" name="unix_name" class="required" value="<?php if (isset($unix_name)) echo $unix_name; ?>" placeholder="Create a login name"/>
			</div> <!-- account_column -->
...
<div class="module_your_profile_picture">
	...
	<div class="submodule_picture">
		...
		<div class="drag_and_drop_wrapper">
			<div class="div_drag_and_drop" id="div_drag_and_drop"><p>To add your photo, drag and drop a file into this box or select a file from your computer. Restrictions: JPG, PNG, GIF, BMP less than 2 MB in file size.</p>
